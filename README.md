...
| [Efficient Agentic Reasoning Through Self-Regulated Simulative Planning](https://arxiv.org/abs/2605.22138) | arXiv 2026 | $25.8\%$-$95.3\%$ fewer reasoning tokens | competitive with much larger systems | not reported | Self-regulates when and how far to plan; depends on trained planning traces/RL |
| [De-Linearizing Agent Traces](https://arxiv.org/abs/2602.02806) | arXiv 2026 | substantial reduction | better dependency recovery | reduced execution time | Infers partial-order executors from linear traces; exact token/latency numbers not in abstract |
...
| [PANDO](https://arxiv.org/abs/2605.24785) | arXiv 2026 | $58\%$-$61\%$ fewer tokens | 58.3% success rate | not reported | Online skill distillation for multimodal web agents; evaluated mainly on VisualWebArena |
| [ZipRL](https://arxiv.org/abs/2605.28069) | arXiv 2026 | adaptive multi-turn compression | +27.9% / +34.7% vs SOTA | not reported | RLVR context compression with hindsight replay; abstract lacks exact token-reduction number |
| [Masking Stale Observations Helps Search Agents](https://arxiv.org/abs/2606.00408) | arXiv 2026 | stale observation masking | regime-dependent gains | not reported | Maps when context masking helps search agents; can hurt saturated models |
| [SkillPager](https://arxiv.org/abs/2606.00822) | arXiv 2026 | $47.04\%$ fewer prompt tokens | 78.89% sufficiency vs 82.23% full-doc | not reported | Query-adaptive retrieval inside skill documents; slight sufficiency drop vs exhaustive context |
| [LatentSkill](https://arxiv.org/abs/2606.06087) | arXiv 2026 | $-64.1\%$ prefill / $-72.2\%$ skill-token overhead | +21.4 / +13.4 pp on ALFWorld; +3.0 EM on Search-QA | lower prefill cost | Stores reusable skills as LoRA adapters; requires skill-adapter generation |
...
| [SWE-Pruner Pro](https://arxiv.org/abs/2607.18213) | arXiv 2026 | up to −39% prompt/completion tokens | +3.8% SWE-Bench Verified; +2.2pp Oolong | bounded overhead | Prunes coding-agent tool outputs using the agent's own representations; evaluated mainly on coding agents |
| [When Replanning Becomes the Bottleneck](https://arxiv.org/abs/2608.01428) | ICML 2026 | −62–92% replanning-call tokens | preserves task success | SLO violations ↓ | Budgeted replanning with E-RECAP; experiments focus mainly on embodied agents |
...
| [AnyTool](https://arxiv.org/abs/2402.04253) | ICML 2024 | −50% search | +12% | ↓2× | Hierarchical dispatcher prunes irrelevant APIs; strong at scale with 16K+ tools |
...
| [BridgeScope](https://arxiv.org/abs/2508.04031) | CIDR 2026 | up to −80% token usage | — | bypasses inter-tool transfer | Modularizes database tools and proxy data transfer for DB agents; strongest evidence is database-specific |
...
| [RepoMaster](https://arxiv.org/abs/2505.21577) | NeurIPS 2025 | repo exploration pruning | +110% valid submissions / 40.7→62.9% pass rate | −95% tokens | Explores GitHub repositories via dependency and call graphs for code agents; software-engineering specific |
...
| [ToolRM](https://arxiv.org/abs/2510.26167) | ACL Findings 2026 | RM-guided tool selection | up to +17.94% weighted tool-call accuracy; +4.64/+5.62 pp RL gains | >66% fewer output tokens on ACEBench | Fine-grained reward models for tool reasoning; needs curated tool-use preference data. |
| [HyFunc](https://arxiv.org/abs/2602.13665) | KDD 2026 | hybrid-model function selection | 80.1% | 0.828 s inference | Accelerates function calls using model cascading and dynamic templates; specialized inference implementation required |
| [OpaqueToolsBench](https://arxiv.org/abs/2602.15197) | CAIS 2026 | interaction-driven tool documentation | outperforms existing methods | 3.5-7.5x fewer total tokens | Learns opaque tool behavior from execution feedback; strongest when tool documentation is incomplete |
...
| [AutoTool](https://arxiv.org/abs/2603.13348) | ICLR 2026 | automatic tool reasoning scaling | +9.8% | ~-81% computational overhead | Uses entropy-constrained RL to adapt tool-use reasoning length; requires RL training |
...
| [Internalizing Tool Knowledge in Small Language Models](https://arxiv.org/abs/2605.17774) | arXiv 2026 | schema omitted; $82.6\%$ shorter input | +0.18 AT-F1 / +1.00 judge score | Qwen run $2.5\times$ faster than Gemma | Moves fixed tool knowledge from prompt to weights; risks forgetting and fixed-catalog assumptions |
| [ToolGate](https://arxiv.org/abs/2606.03054) | arXiv 2026 | token cost to $64$-$69\%$ of ReAct | ≈ average / +1.65 pts matched-domain | fewer unnecessary tool outputs | Skips low-value perceptual tool calls before context insertion; focused on VLM agents |
| [Learning When Not to Act](https://arxiv.org/abs/2606.02132) | arXiv 2026 | $-18.33$-$24.59\%$ tool calls | +7.27% to +10.45% avg performance | lower tool-use cost | Penalizes redundant tool use through agentic RL; under-review status |
| [Self-Reflective APIs](https://arxiv.org/abs/2606.05037) | arXiv 2026 | structured retry guidance | +36.7 to +40.0 pp completion on Anthropic models | $1.8$-$2.2\times$ better per-success token efficiency | Machine-readable API recovery feedback improves repair; gpt-4o-mini result is not significant |
| [Learning Adaptive Parallel Execution](https://arxiv.org/abs/2601.19568) | ACL Findings 2026 | $-67.7\%$ turns | 84.7% file / 56.4% function F1 | $93.6\%$ speedup; $-68.9\%$ tokens | Learns adaptive parallel code localization; tuned for software-search agents |
...
| [Agent Primitives](https://arxiv.org/abs/2602.03695) | arXiv 2026 | reusable latent primitives | +12.0%-$16.5\%$ vs single-agent | $3\times$-$4\times$ lower token/latency vs text MAS | Composes MAS from KV-cache primitives; needs primitive organizer setup |
| [ATOM](https://arxiv.org/abs/2605.26178) | arXiv 2026 | query-conditioned agents | SOTA across six benchmarks | up to $30\%$ token-efficiency gain | Budget-controllable MAS graph activation; budget estimator adds system complexity |
| [MACA](https://arxiv.org/abs/2605.25746) | arXiv 2026 | task/budget-conditioned orchestration | +8.42% average | $43.19\%$ fewer tokens | Jointly adapts MAS structure and orchestration; exact generality beyond tested benchmarks unclear |
| [Self-signals Driven Multi-LLM Debate](https://arxiv.org/abs/2510.06843) | arXiv 2026 | confidence early exit + attention compression | improves over MAD baselines | lower token consumption | Uses self-signals to reduce redundant debate; abstract does not expose exact token delta |
| [MOC](https://arxiv.org/abs/2606.02359) | arXiv 2026 | multi-order communication | improves across six datasets | reduced communication costs | Consolidates multi-hop agent messages under token constraints; exact cost delta not in abstract |
| [Reward Modeling for Multi-Agent Orchestration](https://arxiv.org/abs/2606.13598) | arXiv 2026 | orchestration-level RM | up to +8% accuracy | up to $10\times$ token efficiency | Trains orchestration reward models without human labels; work-in-progress preprint |
...
| [Beyond Sequential Interaction](https://arxiv.org/abs/2607.22689) | arXiv 2026 | parallel planner-worker | 46.4% success; +12.9pp | ~−50% steps; <−50% tokens | Benchmarks parallel GUI coordination; gains depend on decomposable long-horizon GUI tasks |
| [BANDMAS](https://arxiv.org/abs/2608.00458) | arXiv 2026 | packet-level scheduling | highest mean task metric under constrained caps | −53.2–77.3% application-layer bytes | Causality-inspired communication pruning; early paper with limited adoption evidence |
...
| [DeferMem](https://arxiv.org/abs/2605.22411) | arXiv 2026 | query-time evidence distillation | highest QA accuracy on memory QA | fastest runtime; $0$ commercial-API token cost for memory ops | Distills noisy long-term memory evidence at query time; adds RL-trained distiller |
| [Efficient and Transferable Agentic KG-RAG via RL](https://arxiv.org/abs/2509.26383) | arXiv 2026 | single-agent KG interaction | improves KGQA accuracy | fewer generation tokens | Replaces multi-module KG-RAG workflows with one RL agent; KG setting is specialized |
| [PRISM](https://arxiv.org/abs/2605.12260) | arXiv 2026 | min-cost structured-memory retrieval | higher LLM-judge accuracy | order-of-magnitude smaller context budget | Pareto retrieval/compression for long-horizon memory; LoCoMo-focused evidence |
| [DimMem](https://arxiv.org/abs/2605.15759) | arXiv 2026 | dimensional selective recall | 81.43% / 78.20% overall accuracy | $24\%$ lower LoCoMo token cost | Typed atomic memory units improve recall efficiency; depends on schema extraction quality |
| [ExpWeaver](https://arxiv.org/abs/2606.01041) | arXiv 2026 | latent experience retrieval | SOTA on 12/13 tasks | avoids $1.5\times$-$2\times$ text-RAG token overhead | Retrieves past experience in latent space; requires model-integrated architecture |
...
| [TeaRAG](https://arxiv.org/abs/2511.05385) | arXiv 2025 | graph-compressed retrieval | +4% / +2% EM | — | Compresses retrieval content and reasoning steps for agentic RAG; requires IP-DPO training and benchmark-specific setup |
| [PRO-LONG](https://arxiv.org/abs/2607.20064) | arXiv 2026 | programmatic memory search | +18.0pp average; up to 76.1% pass@1 | — | Keeps full interaction logs searchable for long-horizon agents; strongest evidence is on ARC-AGI-3 |
| [BM25 Wins at Scale](https://arxiv.org/abs/2607.26497) | arXiv 2026 | BM25 becomes Pareto-efficient at scale | approaching +20pp at full scale | no LLM construction | Provides a controlled 28-tier accuracy-cost scaling study; conclusions use one reader model and judging protocol |
| [Stop When Memory Suffices](https://arxiv.org/abs/2608.01285) | arXiv 2026 | evidence-conditioned early stopping | 55.17% / 38.77% score | — | Avoids unnecessary deep memory execution; evaluated on two recent benchmarks |
...
| [Agentic AI Workload Characteristics](https://arxiv.org/abs/2605.26297) | arXiv 2026 | decode-dominated workload insight | not applicable | long-lived KV-cache state | Characterizes ReAct-style serving traces; empirical study rather than an optimizer |
| [XGrammar-2](https://arxiv.org/abs/2601.04426) | ACM CAIS 2026 | $>6\times$ faster compilation | same structured validity target | cache reuse across grammars | Dynamic structured generation for tool-calling agents; engine-level contribution |
...
| [Tool Forge](https://arxiv.org/abs/2605.28000) | Tool context/routing | Validation-carrying tool capsules; Router reduces full-catalog schema exposure by $99.2\%$ |
| [EffGen](https://arxiv.org/abs/2602.00887) | Prompt/tool routing for SLM agents | Compresses prompts by 57% on average and up to 70–80%; broad framework makes component attribution harder |
